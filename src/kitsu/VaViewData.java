 ...
 * @author devil
 */
public class VaViewData extends javax.swing.JFrame {

    /**
     * Creates new form VaViewData
     */
    public VaViewData() {
        initComponents();
        table();
    ...
    private void initComponents() {
        ...
        KITSU5.setText("View Voice Actors");
...
public void table(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("Select * from voiceactors order by id");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VaViewData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
