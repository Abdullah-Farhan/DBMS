...
public class OSTUpdate extends javax.swing.JFrame {

    /**
     * Creates new form OSTUpdate
     */
    public OSTUpdate() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        KITSU5.setText("OST's Update Data");
        ...
        KITSU11.setText("New Name");
        jPanel1.add(KITSU11, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 470, -1, -1));
        ...
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 470, 190, 30));

        KITSU12.setFont(new java.awt.Font("Agency FB", 1, 30)); // NOI18N
        KITSU12.setForeground(new java.awt.Color(255, 255, 255));
        KITSU12.setText("Name");
        jPanel1.add(KITSU12, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 160, -1, -1));
        ...
        jPanel1.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 170, 190, 30));
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try{
            ...
            if (!(checkName.equals(name))){
                ...
                if (band.isEmpty()){
                    result = stmt.executeQuery("select * from ost where name = '"+name+"'");
                    while(result.next()){
                        band = result.getString(2);
            ...
            if (check == false){
                if (!(new_name.equals("") || new_name.isEmpty())){
                    ...
                    stmt.executeQuery("update ost"+
                    " set name = '"+new_name+"', band = '"+band+"', show_name = '"+show+"', type = '"+type+"' where name = '"+name+"'");
                    JOptionPane.showMessageDialog(null,"OST Updated Successfully!");
                }

                else if (name.equals(checkName)){
                    System.out.println("else if");
                    stmt.executeQuery("update ost"+
                    " set band = '"+band+"', show_name = '"+show+"', type = '"+type+"' where name = '"+name+"'");
                    JOptionPane.showMessageDialog(null,"OST Updated Successfully!");
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OSTUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
