...
public class ShowViewData extends javax.swing.JFrame {

    /**
     * Creates new form ShowViewData
     */
    public ShowViewData() {
        initComponents();
        table1();
    ...
    private void initComponents() {
        ...
        KITSU9.setText("Shows Genre");
        jPanel1.add(KITSU9, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 330, -1, -1));
    ...
    public void table1(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("Select  image, name, score from anime where anime_type = '"+"Show"+"'");
    ...
    public void table2(){
        try{
            java.sql.Connection mycon = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","hr","hr");//Nom	hr@//localhost:1521/xe
            Statement stmt = mycon.createStatement();
            ResultSet rs = stmt.executeQuery("select name, genre_name from anime cross join genres where anime.name = genres.anime_name and anime_type = '"+"Show"+"' order by name");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowViewData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
