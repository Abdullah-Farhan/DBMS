...
public class MangaAddData extends javax.swing.JFrame {

    protected static String mangaName;
    ...
    private void initComponents() {
        ...
        KITSU19 = new javax.swing.JLabel();
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 270, 570));
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 530, 160, 40));

        KITSU17.setFont(new java.awt.Font("Agency FB", 1, 30)); // NOI18N
        KITSU17.setForeground(new java.awt.Color(255, 255, 255));
        KITSU17.setText("Publisher ID");
        jPanel1.add(KITSU17, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 400, -1, -1));
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 330, 190, 30));
        ...
        KITSU19.setFont(new java.awt.Font("Agency FB", 1, 30)); // NOI18N
        KITSU19.setForeground(new java.awt.Color(255, 255, 255));
        KITSU19.setText("Summary");
        jPanel1.add(KITSU19, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 320, -1, -1));
        ...
        jPanel1.add(jButton15, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 530, 160, 40));
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        String name, duration,summary, published, chapter, volumes, destributer;
        name = jTextField5.getText();
        duration = jTextField2.getText();
        summary = jTextField3.getText();
        published = jTextField6.getText();
        chapter = jTextField7.getText();
        volumes = jTextField8.getText();
        destributer = jTextField4.getText();
        String show = "Manga";
        ...
        try{
            ...
            stmt.executeQuery("insert into Anime(name,duration,summary,studio_sid, anime_type)"+
                        " values ('"+name+"','"+duration+"','"+summary+"','"+destributer+"','"+show+"')");

            JOptionPane.showMessageDialog(null,"Anime Added Successfully!");
        ...
        try{
            ...
            stmt.executeQuery("insert into Manga(name,publishdate, chapters, volumes)"+
                " values ('"+name+"','"+published+"','"+chapter+"','"+volumes+"')");

            JOptionPane.showMessageDialog(null,"Manga Added Successfully!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MangaAddData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MangaAddData().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel KITSU19;
