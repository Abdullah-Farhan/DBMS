 ...
 * @author MNA
 */
public class AddViewGame extends javax.swing.JFrame {

    /**
     * Creates new form AddViewGame
     */
    public AddViewGame() {
        initComponents();
        table();
    ...
    private void initComponents() {
        ...
        KITSU5.setText("Add and View Game");
        ...
        KITSU14.setText("View Game");
        jPanel1.add(KITSU14, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 70, -1, -1));

        jButton10.setBackground(new java.awt.Color(204, 204, 204));
        jButton10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton10.setText("View Game");
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 470, 160, 40));
        ...
        jPanel1.add(KITSU11, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 290, -1, -1));

        jTextField5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTextField5.setForeground(new java.awt.Color(102, 102, 102));
        jTextField5.setText("Anime Name");
        ...
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, 190, 30));

        jButton15.setBackground(new java.awt.Color(204, 204, 204));
        jButton15.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton15.setText("Add Game");
        ...
        jPanel1.add(jButton15, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 470, 160, 40));

        KITSU18.setFont(new java.awt.Font("Agency FB", 1, 30)); // NOI18N
        KITSU18.setForeground(new java.awt.Color(255, 255, 255));
        KITSU18.setText("Add Game");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 140, 330, 310));
...
public void table(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("select id, name from game");
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        try{
            java.sql.Connection mycon = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","hr","hr");//Nom	hr@//localhost:1521/xe
            Statement stmt = mycon.createStatement();
            ResultSet result = stmt.executeQuery("Select max(id) as id from game");
            ...
            stmt.executeQuery("insert into game(id, name) values ('"+id+"','"+name+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddViewGame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
