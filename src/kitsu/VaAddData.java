...
public class VaAddData extends javax.swing.JFrame {

    /**
     * Creates new form VaAddData
     */
    public VaAddData() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        KITSU5.setText("Voice Actor Add Data");
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 250, 190, 30));
        ...
        KITSU16.setText("Description");
        jPanel1.add(KITSU16, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 240, -1, -1));
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 340, 190, 30));
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try{
            String name, description, gender, id = "";
            ...
            ResultSet result = stmt.executeQuery("Select max(id) as sid from voiceactors");
            ...
            stmt.executeQuery("insert into voiceactors values ('"+id+"','"+name+"','"+description+"','"+gender+"')");

            JOptionPane.showMessageDialog(null,"Voice Actor Added Successfully!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VaAddData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
