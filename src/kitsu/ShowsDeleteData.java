...
public class ShowsDeleteData extends javax.swing.JFrame {

    /**
     * Creates new form ShowsDeleteData
     */
    public ShowsDeleteData() {
        initComponents();
        table();
    }
    ...
    private void initComponents() {
        ...
        KITSU14.setText("Shows");
        jPanel1.add(KITSU14, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 60, -1, -1));

        jButton10.setBackground(new java.awt.Color(204, 204, 204));
        jButton10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton10.setText("View Shows");
...
public void table(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("select name, score, summary from anime where anime_type = 'Show' order by name");
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        try{
            java.sql.Connection mycon = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","hr","hr");//Nom	hr@//localhost:1521/xe
            Statement stmt = mycon.createStatement();
            ResultSet result = stmt.executeQuery("Select name, score, summary from anime where anime_type = 'Show' and name = '"+name+"'");
            ...
            if (check == true){
                ...
                stmt.executeQuery("delete from ost where show_name = '"+name+"'");
                System.out.println("ost done");
                stmt.executeQuery("delete from animestatusv1 where anime_name = '"+name+"'");
                stmt.executeQuery("delete from game where name1 = '"+name+"'");
                System.out.println("stat done");
                stmt.executeQuery("delete from show where name = '"+name+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowsDeleteData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
