 ...
 * @author devil
 */
public class OSTViewData extends javax.swing.JFrame {

    /**
     * Creates new form OSTViewData
     */
    public OSTViewData() {
        initComponents();
        table();
    ...
    private void initComponents() {
        ...
        KITSU9.setText("Original Sound Tracks");
...
public void table(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("Select * from ost");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OSTViewData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
