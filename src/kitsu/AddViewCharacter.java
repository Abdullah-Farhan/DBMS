...
import kitsu.Adddata;
import kitsu.AdminDashboard;
import kitsu.DashboadFrame;
import kitsu.ViewData;

/**
 *
 * @author MNA
 */
public class AddViewCharacter extends javax.swing.JFrame {

    /**
     * Creates new form AddViewCharacter
     */
    public AddViewCharacter() {
        initComponents();
        table();
    }
    ...
    private void initComponents() {
        ...
        KITSU5.setText("Add and View Character");
        ...
        KITSU15.setText("Anime");
        jPanel1.add(KITSU15, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 200, -1, -1));

        KITSU14.setFont(new java.awt.Font("Agency FB", 1, 30)); // NOI18N
        KITSU14.setForeground(new java.awt.Color(255, 255, 255));
        KITSU14.setText("View Characters");
        jPanel1.add(KITSU14, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 60, -1, -1));

        jButton10.setBackground(new java.awt.Color(204, 204, 204));
        jButton10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton10.setText("View Character");
        ...
        KITSU17.setText("Voice Actor");
        jPanel1.add(KITSU17, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, -1, -1));

        jTextField2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTextField2.setForeground(new java.awt.Color(102, 102, 102));
        jTextField2.setText("Anime name");
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 240, 190, 30));
        ...
        jPanel1.add(KITSU11, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 120, -1, -1));

        jTextField5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTextField5.setForeground(new java.awt.Color(102, 102, 102));
        jTextField5.setText("Character");
        ...
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 160, 190, 30));

        jButton15.setBackground(new java.awt.Color(204, 204, 204));
        jButton15.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton15.setText("Add Character");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Anime", "Role", "Voice Actor"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 110, 490, 330));

        jTextField3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(102, 102, 102));
        jTextField3.setText("Main/Side");
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, 190, 30));

        KITSU19.setFont(new java.awt.Font("Agency FB", 1, 30)); // NOI18N
        KITSU19.setForeground(new java.awt.Color(255, 255, 255));
        KITSU19.setText("Role");
        jPanel1.add(KITSU19, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 280, -1, -1));

        jTextField4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTextField4.setForeground(new java.awt.Color(102, 102, 102));
        jTextField4.setText("Voice Actor ID");
        ...
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 390, 190, 30));
    ...
    public void table(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("select characters.id, characters.name, characters.anime_name ,characters.role, voiceactors.name as va "+
            "from characters cross join voiceactors " +
            "where characters.voiceactors_id = voiceactors.id order by id");
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        String id, name, anime, role, va;
        name = jTextField5.getText();
        anime = jTextField2.getText();
        role = jTextField3.getText();
        va = jTextField4.getText();
        id = "";
        try{
            java.sql.Connection mycon = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","hr","hr");//Nom	hr@//localhost:1521/xe
            Statement stmt = mycon.createStatement();
            ResultSet result = stmt.executeQuery("Select max(id) as id from characters");
            ...
            stmt.executeQuery("insert into characters values ('"+name+"','"+role+"','"+id+"','"+anime+"','"+va+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddViewCharacter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
