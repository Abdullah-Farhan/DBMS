 ...
 * @author devil
 */
public class MangaViewData extends javax.swing.JFrame {

    /**
     * Creates new form MangaViewData
     */
    public MangaViewData() {
        initComponents();
        table();
    }
    ...
    public void table(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("Select  image, name, score from anime where anime_type = '"+"Manga"+"'");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 210, 690, 200));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MangaViewData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MangaViewData().setVisible(true);
            }
        });
    }
