...
public class StudioAddData extends javax.swing.JFrame {

    /**
     * Creates new form StudioAddData
     */
    public StudioAddData() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Established Year");
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try{
            String name, established, sid = "";
            name = jTextField5.getText();
            established = jTextField2.getText();
            ...
            ResultSet result = stmt.executeQuery("Select max(sid) as sid from studios");
            
            while(result.next()){
                System.out.println(result.getString(1));
                sid = (result.getString(1));
                int i = Integer.parseInt(sid)+1;
                sid = String.valueOf(i);
            }
            
            System.out.println(sid);
            
            stmt.executeQuery("insert into studios values ('"+sid+"','"+name+"','"+established+"')");
           
      
            JOptionPane.showMessageDialog(null,"Studio Added Successfully!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudioAddData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
