 ...
 * @author devil
 */
public class ShowsAddData extends javax.swing.JFrame {
protected static String animeName;
    public ShowsAddData() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 40, 280, 560));
        ...
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 390, 190, 30));
        ...
        jPanel1.add(KITSU12, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 390, -1, -1));
        ...
        jTextField6.setText("Series/Movie");
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try{
            ...
            stmt.executeQuery("insert into Anime(name,duration,score,summary,studio_sid, anime_type)"+
                " values ('"+name+"','"+duration+"','"+score+"','"+summary+"','"+studio+"','"+show+"')");
        ...
        try{
            ...
            stmt.executeQuery("insert into Show(name,type,airdate,episodes)"+
                " values ('"+name+"','"+type+"','"+airdate+"','"+episodes+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowsAddData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowsAddData().setVisible(true);
            }
        });
    }
