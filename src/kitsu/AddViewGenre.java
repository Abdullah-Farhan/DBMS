 ...
 * @author MNA
 */
public class AddViewGenre extends javax.swing.JFrame {

    /**
     * Creates new form AddViewGenre
     */
    public AddViewGenre() {
        initComponents();
        table();
    ...
    private void initComponents() {
        ...
        KITSU5.setText("Add and View Genre");
        ...
        KITSU14.setText("View Genre");
        jPanel1.add(KITSU14, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 60, -1, -1));

        jButton10.setBackground(new java.awt.Color(204, 204, 204));
        jButton10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton10.setText("View Genre");
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 470, 160, 40));
        ...
        jPanel1.add(KITSU11, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 260, -1, -1));
        ...
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 190, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 110, 360, 340));
...
public void table(){
        try{
            ...
            JOptionPane.showMessageDialog(null,"No Genre's Exist!");
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        try{
            java.sql.Connection mycon = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","hr","hr");//Nom	hr@//localhost:1521/xe
            Statement stmt = mycon.createStatement();
            stmt.executeQuery("insert into genre values('"+genre+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddViewGenre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
