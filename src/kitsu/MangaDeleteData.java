...
public class MangaDeleteData extends javax.swing.JFrame {

    /**
     * Creates new form MangaDeleteData
     */
    public MangaDeleteData() {
        initComponents();
        table();
    }
    ...
    private void initComponents() {
        ...
        jButton15.setText("Delete Manga");
    ...
    public void table(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("select name, score, summary from anime where anime_type = 'Manga' order by name");
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        try{
            java.sql.Connection mycon = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","hr","hr");//Nom	hr@//localhost:1521/xe
            Statement stmt = mycon.createStatement();
            ResultSet result = stmt.executeQuery("Select name, score, summary from anime where anime_type = 'Manga' and name = '"+name+"'");
            ...
            if (check == true){
                stmt.executeQuery("delete from favorite where anime_name = '"+name+"'");
                System.out.println("fav done");
                stmt.executeQuery("delete from review where anime_name = '"+name+"'");
                System.out.println("rev done");
                stmt.executeQuery("delete from game where name = '"+name+"'");
                System.out.println("game done");
                stmt.executeQuery("delete from characters where anime_name = '"+name+"'");
                System.out.println("char done");
                stmt.executeQuery("delete from genres where anime_name = '"+name+"'");
                System.out.println("gen done");
                stmt.executeQuery("delete from animestatusv1 where anime_name = '"+name+"'");
                System.out.println("stat done");
                stmt.executeQuery("delete from manga where name = '"+name+"'");
                System.out.println("show done");
                stmt.executeQuery("delete from anime where name = '"+name+"'");

                JOptionPane.showMessageDialog(null,"Manga Deleted Successfully!");
            }
            else{
                JOptionPane.showMessageDialog(null,"Manga Does Not Exist!");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MangaDeleteData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
