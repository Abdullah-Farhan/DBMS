...
public class VADeleteData extends javax.swing.JFrame {

    /**
     * Creates new form VADeleteData
     */
    public VADeleteData() {
        initComponents();
        table();
    ...
    private void initComponents() {
        ...
        jPanel2.add(KITSU5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, -1, -1));
    ...
    public void table(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("select name, description, gender from voiceactors order by name");
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        try{
            java.sql.Connection mycon = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","hr","hr");//Nom	hr@//localhost:1521/xe
            Statement stmt = mycon.createStatement();
            ResultSet result = stmt.executeQuery("Select name, description, gender from voiceactors where name = '"+name+"'");
            ...
            if (check == true){
                result = stmt.executeQuery("Select * from voiceactors where name = '"+name+"'");
                while(result.next()){
                    id = result.getString(1);
                    i = Integer.parseInt(id);
                }
                stmt.executeQuery("update characters set voiceactors_id = null where voiceactors_id = '"+i+"'");
                stmt.executeQuery("delete from voiceactors where name = '"+name+"'");

                JOptionPane.showMessageDialog(null,"Voice Actor Deleted Successfully!");
            }
            else{
                JOptionPane.showMessageDialog(null,"Voice Actor Does Not Exist!");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VADeleteData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
