 ...
 * @author devil
 */
public class UserViewData extends javax.swing.JFrame {

    /**
     * Creates new form UserViewData
     */
    public UserViewData() {
        initComponents();
        table();
    ...
    private void initComponents() {
        ...
        KITSU9.setText("No. of Shows Rated by User");
        jPanel1.add(KITSU9, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 320, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 100, 690, 200));

        KITSU10.setFont(new java.awt.Font("Agency FB", 1, 30)); // NOI18N
        KITSU10.setForeground(new java.awt.Color(255, 255, 255));
        KITSU10.setText("Users");
        jPanel1.add(KITSU10, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 60, -1, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 380, 690, 200));
...
public void table(){
        try{
            ...
            ResultSet rs = stmt.executeQuery("Select * from Accounts where username != '"+"Admin"+"'");
...
public void table2(){
        try{
            java.sql.Connection mycon = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","hr","hr");//Nom	hr@//localhost:1521/xe
            Statement stmt = mycon.createStatement();
            ResultSet rs = stmt.executeQuery("select count(user_email) as amount, user_email from status group by user_email order by amount desc");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserViewData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserViewData().setVisible(true);
            }
        });
    }
